...
namespace ReactiveUI.XamForms
{
    ...
    public class ViewModelViewHost : ContentView, IViewFor
    {
        ...
        public static readonly BindableProperty DefaultContentProperty = BindableProperty.Create(nameof(DefaultContent),
                                                                                            typeof(View),
                                                                                            typeof(ViewModelViewHost));
        ...
        public static readonly BindableProperty ViewContractObservableProperty = BindableProperty.Create(nameof(ViewContractObservable),
                                                                                            typeof(IObservable<string>),
                                                                                            typeof(ViewModelViewHost), Observable.Never<string>());
