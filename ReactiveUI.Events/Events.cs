...
namespace MediaPlayer.Rx
{
    public  partial class MPPlayableContentDelegateRx : MPPlayableContentDelegate
    {
        ...
        readonly SingleAwaitSubject<Tuple<MediaPlayer.MPPlayableContentManager, System.Action<Foundation.NSError>>> _InitializePlaybackQueue = new SingleAwaitSubject<Tuple<MediaPlayer.MPPlayableContentManager, System.Action<Foundation.NSError>>>();
        public IObservable<Tuple<MediaPlayer.MPPlayableContentManager, System.Action<Foundation.NSError>>> InitializePlaybackQueueObs { get { return _InitializePlaybackQueue; } }
        public override void InitializePlaybackQueue(MediaPlayer.MPPlayableContentManager contentManager, System.Action<Foundation.NSError> completionHandler)
        {
            _InitializePlaybackQueue.OnNext(Tuple.Create(contentManager, completionHandler));
        }
